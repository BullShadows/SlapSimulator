...
class StretchableImage(Widget):
    ...
    def on_touch_move(self, touch):
        ...
        self.vertices[3] = mouse_y + self.image_height / 2  # Top-right y (window.width/2+self.image_width/2)+mouse_x/10
...
class CenteredImage(Widget):
    ...
    def on_touch_move(self, touch):
        ...
        # Update top-left and top-right vertices
            self.vertices[0] = self.stretchable_image.vertices[0] - self.image_width / 2  # Top-left x
